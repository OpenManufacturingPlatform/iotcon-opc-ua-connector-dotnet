...
{
    internal static class AlarmConversion
    {
        private const string ArrayPostfix = "[]";

        #region Conversion methods

        internal static List<object> ConvertToAlarm(object value, IMapper mapper)
        {
            ...
            //    return ConvertToAlarms(list as IList, mapper);

            //if (value is Dictionary<string, object> dict)
            //    return ConvertDictionaryToMeasurements(dict, mapper);
        ...
        //internal static SensorMeasurements ConvertToAlarms(IList list, IMapper mapper)
        //{
        ...
        //        measurement.Value = ConvertToAlarm(item, mapper);
        //        measurements.Add(measurement);
        //    }
        //    return measurements;
        //}
        ...
        //internal static IMeasurementValue ConvertDictionaryToMeasurements(Dictionary<string, object> dictionary, IMapper mapper)
        //{
        //    var measurements = new SensorMeasurements();
            
        //    foreach (var keyValPair in dictionary)
        //    {
        //        var propVal = ConvertProperty(keyValPair.Value, mapper);

        //        measurements.Add(new SensorMeasurement()
        //        {
        //            DataType = "",
        //            Key = keyValPair.Key,
        //            Value = ConvertToAlarm(propVal, mapper)
        //        });
        //    }
        //    return measurements;
        //}
